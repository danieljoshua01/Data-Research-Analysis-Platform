    ...
    <div>
        <div class="bg-primary-blue-100 w-full h-full fancy-top-bottom">
            <div class="flex flex-col">
                ...
                <div class="flex flex-col lg:flex-row w-3/4 lg:w-full justify-center text-lg text-white mt-10 m-auto">
                ...
                <div class="flex flex-col lg:flex-row w-3/4 lg:w-full justify-center text-lg text-white lg:mt-10 m-auto">
                    <div class="flex flex-col lg:w-1/4 lg:pr-10 mb-10 lg:mb-0">
                        <h2 class="font-bold">
