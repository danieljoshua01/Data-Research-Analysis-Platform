        ...
        <div class="bg-white rounded-xl p-12 shadow-2xl max-w-lg w-full text-center sm:p-8">
            ...
            <div v-else-if="state.error" class="flex flex-col items-center gap-5">
                ...
                <button @click="router.back()"
                    class="px-6 py-3 rounded-lg text-base font-medium border-0 cursor-pointer transition-all duration-200 mt-4 bg-indigo-500 text-white hover:bg-indigo-600 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-indigo-500/40">
                    Go Back
                </button>
            </div>
        </div>
