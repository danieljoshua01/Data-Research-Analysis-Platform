<template>
  <div class="report-detail-container">
    ...
    <div v-else-if="state.error" class="error-state">
      ...
      <p>{{ state.error }}</p>
      <button class="btn-primary" @click="router.push(`/marketing-projects/${projectId}/insights`)">
        Back to Insights
      </button>
    </div>
    ...
    <div v-else-if="state.report" class="report-content">
      ...
      <div class="report-header">
        <button class="btn-back" @click="router.push(`/marketing-projects/${projectId}/insights`)">
...
async function confirmDelete() {
  ...
  if (result.isConfirmed) {
    ...
    if (deleteResult.success) {
      ...
      router.push(`/marketing-projects/${projectId}/insights`);
    } else {
      $swal.fire({
        icon: 'error',
        title: 'Delete Failed',
