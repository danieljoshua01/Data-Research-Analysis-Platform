...
<template>
    ...
    <tab-content-panel :corners="['top-left', 'top-right', 'bottom-left', 'bottom-right']" class="mt-10">
        ...
        <div v-else-if="projects.length === 0"
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-2">No Marketing Projects Yet</h3>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
                ...
                <!-- Clickable area -->
                <NuxtLink :to="`/marketing-projects/${project.id}`" @click="setSelectedProject(project.id)" class="cursor-pointer block">
                    <!-- Header with badges -->
                    ...
                    <!-- Action Button -->
                    <button
                        @click.prevent="setSelectedProject(project.id); $router.push(`/marketing-projects/${project.id}`)"
