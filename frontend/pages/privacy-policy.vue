...
<template>
    <article class="w-3/4 h-full m-auto mt-10 p-5" itemscope itemtype="https://schema.org/Article">
        ...
        <div class="border-l-4 border-blue-500 pl-4 my-4 bg-blue-50 p-4 rounded">
            ...
            <p class="mt-2">
                <strong>Countries Covered:</strong> Austria, Belgium, Bulgaria, Croatia, Cyprus, Czech Republic, Denmark, Estonia, Finland, France, Germany, Greece, Hungary, Iceland, Ireland, Italy, Latvia, Liechtenstein, Lithuania, Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Romania, Slovakia, Slovenia, Spain, Sweden, Switzerland, United Kingdom
            </p>
        </div>
        ...
        <ul>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Data Research Analysis (SMC-Private) Limited, accessible from <a href="http://www.dataresearchanalysis.com" rel="external nofollow noopener" target="_blank">http://www.dataresearchanalysis.com</a>
                </p>
            </li>
            <li>
                <p>
