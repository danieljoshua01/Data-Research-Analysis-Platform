            ...
            <div class="bg-white rounded-xl p-8 shadow-sm sm:p-6">
                ...
                <div class="flex gap-3 justify-end mt-8 sm:flex-col">
                    ...
                    <button @click="nextStep"
                        class="px-6 py-3 rounded-lg text-base font-medium border-0 cursor-pointer transition-all duration-200 bg-primary-blue-100 text-white hover:bg-primary-blue-300 hover:-translate-y-0.5 hover:shadow-lg sm:w-full">
                        Continue →
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm sm:p-6">
                ...
                <div class="flex gap-3 justify-end mt-8 sm:flex-col">
                    ...
                    <button @click="connect"
                        class="px-6 py-3 rounded-lg text-base font-medium border-0 cursor-pointer transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed bg-primary-blue-100 text-white hover:bg-primary-blue-300 hover:-translate-y-0.5 hover:shadow-lg sm:w-full"
                        :disabled="state.connecting">
