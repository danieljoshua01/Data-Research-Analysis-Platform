                ...
                <div class="flex flex-row justify-center">
                    <div class="w-3/4 flex flex-col p-5">
                        ...
                        <div class="flex flex-col mt-10">
                            <img src="/assets/images/google-analytics.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 m-auto rounded-lg" alt="Google Analytics" />
                            <img src="/assets/images/google-ads.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="Google Ads" />
                            <img src="/assets/images/google-ad-manager.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg mt-5 p-5 m-auto rounded-lg" alt="Google Ad Manager" />
                            <img src="/assets/images/excel.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="Excel" />
                            <img src="/assets/images/pdf.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="PDF" />
                            <img src="/assets/images/postgresql.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="PostgreSQL" />
                            <img src="/assets/images/mysql.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="MySQL" />
                            <img src="/assets/images/mariadb.png" class="w-1/2 border-1 border-primary-blue-100 shadow-lg p-5 mt-5 m-auto rounded-lg" alt="MariaDB" />
                        </div>
                    </div>
                </div>
            </div>
