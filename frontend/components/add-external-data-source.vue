...
<template>
    <div class="flex flex-col">
        ...
        <div class="flex flex-col mb-10 lg:hidden">
            ...
            <div class="flex flex-row justify-center">
                <div class="w-3/4 flex flex-col p-5">
                    <img src="/assets/images/data-sources.gif" class="w-full border-5 border-primary-blue-100 shadow-lg mt-10 m-auto" />
                </div>
            </div>
        </div>
        <div class="hidden lg:flex lg:flex-row lg:justify-center lg:mb-10">
            ...
            <div class="w-1/2 flex flex-col mt-10 p-5">
                <img src="/assets/images/data-sources.gif" class="w-full border-5 border-primary-blue-100 shadow-lg mt-10" />
            </div>
        </div>
    </div>
</template>