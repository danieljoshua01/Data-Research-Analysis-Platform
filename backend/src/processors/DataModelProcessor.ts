        ...
        return new Promise<boolean>(async (resolve, reject) => {
            ...
            try {
                ...
                columnsForTableCreation.forEach((column: any, index: number) => {
                    ...
                    } else if (column && (column.schema === 'dra_excel' || column.schema === 'dra_pdf' || column.schema === 'dra_mongodb' || column.schema === 'dra_google_analytics' || column.schema === 'dra_google_ad_manager' || column.schema === 'dra_google_ads' || column.schema === 'dra_meta_ads')) {
                        // For special schemas (Excel, PDF, MongoDB, GA, GAM, Google Ads, Meta Ads), always use table_name regardless of aliases
