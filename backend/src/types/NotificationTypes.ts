...
export enum NotificationType {
    // Project Management Notifications (10 types)
    ...
    // Data Source Operations (13 types)
    ...
    // Admin User Management (3 types - Admin only)
