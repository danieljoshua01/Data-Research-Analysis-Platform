...
import { IWidgetSpec } from "./IWidgetSpec.js";
...
export interface IDashboardChart {
    ...
    /** Distinguishes data-model widgets from AI Insights widgets */
    source_type?: 'data_model' | 'ai_insights';
    /**
     * Parameterised SELECT statement generated by Gemini.
     * $1 = startDate (DATE), $2 = endDate (DATE)
     */
    ai_sql?: string | null;
    /** Full widget spec returned by Gemini (chart type, axes, description) */
    ai_chart_spec?: IWidgetSpec | null;
    /** user_id of the user who created this AI widget */
