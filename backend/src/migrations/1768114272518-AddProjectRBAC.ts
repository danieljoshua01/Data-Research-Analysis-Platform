...
export class AddProjectRBAC1768114272518 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dra_data_model_sources" DROP CONSTRAINT IF EXISTS "FK_dra_data_model_sources_users_platform"`);
        await queryRunner.query(`ALTER TABLE "dra_data_model_sources" DROP CONSTRAINT IF EXISTS "FK_dra_data_model_sources_data_source"`);
        await queryRunner.query(`ALTER TABLE "dra_data_model_sources" DROP CONSTRAINT IF EXISTS "FK_dra_data_model_sources_data_model"`);
        await queryRunner.query(`ALTER TABLE "dra_table_metadata" DROP CONSTRAINT IF EXISTS "FK_table_metadata_users_platform"`);
        await queryRunner.query(`ALTER TABLE "dra_table_metadata" DROP CONSTRAINT IF EXISTS "FK_table_metadata_data_source"`);
        await queryRunner.query(`ALTER TABLE "dra_cross_source_join_catalog" DROP CONSTRAINT IF EXISTS "FK_join_catalog_user"`);
        await queryRunner.query(`ALTER TABLE "dra_cross_source_join_catalog" DROP CONSTRAINT IF EXISTS "FK_join_catalog_right_source"`);
        await queryRunner.query(`ALTER TABLE "dra_cross_source_join_catalog" DROP CONSTRAINT IF EXISTS "FK_join_catalog_left_source"`);
        await queryRunner.query(`ALTER TABLE "sync_history" DROP CONSTRAINT IF EXISTS "fk_data_source"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ai_messages_conversation"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ai_conversations_data_source_user"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ai_conversations_saved_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_dra_data_model_sources_data_model"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_dra_data_model_sources_data_source"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_dra_data_model_sources_users_platform"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_dra_data_model_sources_created_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_table_metadata_data_source"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_table_metadata_schema_physical"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_table_metadata_logical_name"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_table_metadata_users_platform"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_dra_data_models_created_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_join_catalog_left_source_table"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_join_catalog_right_source_table"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_join_catalog_usage_count"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_sync_history_data_source_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_sync_history_status"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."idx_sync_history_started_at"`);
        await queryRunner.query(`ALTER TABLE "dra_data_model_sources" DROP CONSTRAINT IF EXISTS "UQ_data_model_source"`);
        await queryRunner.query(`ALTER TABLE "dra_table_metadata" DROP CONSTRAINT IF EXISTS "UQ_table_metadata_physical"`);
        ...
        await queryRunner.query(`ALTER TABLE "dra_data_model_sources" DROP COLUMN IF EXISTS "updated_at"`);
        await queryRunner.query(`ALTER TABLE "dra_ai_data_model_messages" DROP CONSTRAINT IF EXISTS "FK_f2972dca04719537b6bb5af6d7f"`);
        ...
        await queryRunner.query(`ALTER TABLE "dra_ai_data_model_conversations" DROP CONSTRAINT IF EXISTS "FK_f7ccbe1cc8af906b787c6a15a67"`);
        await queryRunner.query(`ALTER TABLE "dra_ai_data_model_conversations" DROP CONSTRAINT IF EXISTS "FK_74e7cc7659cda3c87ea95f36343"`);
