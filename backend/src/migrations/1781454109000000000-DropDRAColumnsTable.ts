...
export class DropDRAColumnsTable1781454109000000000 implements MigrationInterface {
    name = 'DropDRAColumnsTable1781454109000000000'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dra_columns" DROP CONSTRAINT IF EXISTS "FK_dra_columns_data_source"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_dra_columns_data_model_id"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "dra_columns"`);
    }
