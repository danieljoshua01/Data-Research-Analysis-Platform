        ...
        stage('Build Frontend') {
            steps {
                sh '''
                    ...
                    cd frontend && printf NUXT_API_URL=$NUXT_API_URL\rNUXT_RECAPTCHA_SITE_KEY=$NUXT_RECAPTCHA_SITE_KEY\rNUXT_PORT=$NUXT_PORT\rNUXT_GA_ID=$NUXT_GA_ID\rNUXT_PLATFORM_ENABLED=$NUXT_PLATFORM_ENABLED > .env && npm ci && npm run build
                    ls -al
                '''
            }
        }
